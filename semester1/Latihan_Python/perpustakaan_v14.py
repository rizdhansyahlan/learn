print("NIM : 17210563")
print("Nama : Reihan Darussalam")
print("Kelas : 17.1A.11")
print("Nama Ketua Kelompok: Reihan Darussalam")
print(52*"-")
...
# elif menu1 == "3":
		# Baca_Buku = input('Masukkan nomor urut buku yang ingin dibaca: ')
		# if Baca_Buku == 1 or Baca_Buku == "1":
			# print(isi_buku[1])
		# elif Baca_Buku == 2 or Baca_Buku == "2":
			# print(isi_buku[2])
		# elif Baca_Buku == 3 or Baca_Buku == "3":
			# print(isi_buku[3])
		# elif Baca_Buku == 3 or Baca_Buku == "4":
			# print(isi_buku[4])
		# elif Baca_Buku == 5 or Baca_Buku == "5":
			# print(isi_buku[5])
	# else:
		# print('Kode menu anda, salah')